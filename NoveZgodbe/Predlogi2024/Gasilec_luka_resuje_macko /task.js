    ...
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		languageStrings: {
			sl: {
				...
				messages:{
					itemsExist: "Gasilec ni resil mačke",
					itemsDontExist: "Gasilec je resil muco",
				},
		...
		itemTypes: {
			robot0: { img: ["miha_all_8_sides.png"], side: 140,nbStates: 9,offsetX: -20,offsetY: 30, zOrder: 8, category: {'robot': true}, },
			coin: {num:3, img:["mucek.png"],side: 100,zOrder: 2, category:{"coin":true}},
